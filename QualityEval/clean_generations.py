...
def clean_starcoder(dataset):
    main_path = f'/path/to/output_cot_orig_full/StarCoder/{dataset}'
    output_path = '/path/to/MTP/output_cot_orig/StarCoder/'
...
def clean_gpt4(dataset):
    main_path = f'/path/to/gpt4_exp/output_autocot2d_full/gpt-4/{dataset}'
    output_path = '/path/to/gpt4_exp/output_autocot2d/gpt-4/'
...
def clean_gpt(dataset):
    main_path = f'/path/to/gpt-4/{dataset}'
    output_path = '/path/to/gpt4_exp/output_t7_noid/gpt-4/'
...
'''
python3 /path/to/clean_generations.py --source_lang Python --target_lang Java --model starcoder --approach autocot2d --dataset avatar
